package vboot.config.security;

import vboot.config.dbx.redis.RedisHandler;
import vboot.config.security.authn.AuthnFailedHandler;
import vboot.config.security.authz.AuthzDeniedHandler;
import vboot.config.security.jwt.JwtFilterAdapter;
import vboot.config.security.jwt.JwtHandler;
...
//        configuration.setAllowedOrigins(Collections.singletonList("http://localhost:3100"));
    ...
    public void configure(WebSecurity web) {
        web.ignoring().antMatchers("/","/assets/**","/assets/**","/druid/**","/login", "/pub/**","/index.html","/vben.html","/vue.html","/favicon.ico","/resource/**","/_app.config.js");
//        web.ignoring().antMatchers("/","/sys/**","/oa/**","/sa/**","/te/**","/assets/**","/druid/**","/login", "/pub/**","/index.html","/vben.html","/favicon.ico","/resource/**","/_app.config.js");
