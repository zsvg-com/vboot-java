...
import com.abc.module.te.prod.cate.TeProdCate;
import com.abc.module.te.prod.cate.TeProdCateService;
...
@RestController
@RequestMapping("te/prod/test")
public class TeProdTestApi {

    //分页特性分类
    @GetMapping
    public RestResult get(String name) {
        Sqler sqler = new Sqler("te_prod_test");
